...
/*
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts
                ...
                .setissuedAt(new Date(System.currentTimeMillies()))
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        return (correo.equals(userDetails.getCorreo())) && !isTokenExpired(token);
    }
    ...
    public String generateToken(UserDetails userDetails, String nombres) {
